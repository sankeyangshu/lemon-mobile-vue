const local: App.I18n.I18nScheme = {
  ...
  home: {
    info: 'Mobile Web Application Template based on Vue 3 Ecosystem',
    vue: 'Vue3 + Vite7',
    typescript: 'TypeScript',
    vant: 'Vant component library',
    pinia: 'Pinia state management',
    tailwind: 'tailwindcss v4 atomic class framework',
    router: 'Vue Router + unplugin-vue-router',
    hooks: 'VueUse Hooks',
    syntax: 'Vue 3.5+ latest syntax',
    setup: 'Use the latest script setup syntax',
    utils: 'Built-in Echarts VueUse',
